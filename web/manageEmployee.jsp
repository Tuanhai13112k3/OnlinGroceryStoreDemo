                            ...
                            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>#SR28746</td>
                                        <td>Nguyễn Đăng Khiêm</td>
                                        <td><img class="img-card-person" src="/img-anhthe/4.jpg" alt=""></td>
                                        <td>Thôn 3, Thạch Hòa, Thạch Thất, Hà Nội </td>
                                        <td>14/03/2003</td>
                                        <td>Nam</td>
                                        <td>0916706633</td>
                                        <td>Nhân Viên</td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" required value="ex:Ngô Bá Khá">
                            </div>
                            <div class="form-group  col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" required value="ex:truong.vd2000@gmail.com">
                            </div>
                            <div class="form-group col-md-6">
                                <label class="control-label">Ngày sinh</label>
                                <input class="form-control" type="date" value="mm/dd/yy">
                            </div>
                            <div class="form-group  col-md-6">
